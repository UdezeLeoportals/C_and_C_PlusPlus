...
ManagedString Holy, Spirit, Grace;
...
{       mercy++;
        ...
        if(mercy==1){
            ...
            //print_hex((BYTE*)Christ_, strlen(Christ_));
            //uBit.serial.printf("\n%d",strlen(Christ_));
        }
        ...
        //Receive second half of ciphertext
          ...
          Spirit = uBit.radio.datagram.recv(); 
            ...
            //uBit.serial.printf("\n");
            //print_hex((BYTE*)Christ_cypherSalt,strlen(Christ_cypherSalt));
            sprintf(JesusChrist_cypher, "%s%s",Christ_, Christ_cypherSalt);
            //uBit.serial.printf("\n");
            print_hex((BYTE*)JesusChrist_cypher,strlen(JesusChrist_cypher));
         ...
         print_hex((BYTE*)JesusChrist_cypher, 16);
          ...
          //AES ECB DECRYPTION
            ...
            if(i%2 != 0) sprintf(Gospel_command5 , "%s%c", Gospel_command5 , hex_to_ascii(lord, enc_buf4[i]));
             ...
             char g[50]; int j;
             sprintf(g, "%02x", JesusChrist_cypher[0]);
             for(j=1; j<16; j++)
             sprintf(g, "%s%02x", g, JesusChrist_cypher[j]);
