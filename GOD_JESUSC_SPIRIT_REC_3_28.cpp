...
int mercy=0;
char *Christ_cypherSalt, *Christ_, GODly[50], HEAVEN[50];
...
{       mercy++;
       ...
       // Christ_= (char*)Holy.toCharArray();
        ...
        //if(mercy==1)
        //sprintf(HEAVEN, "%s", Christ_);
        if(mercy==2)
        sprintf(GODly, "%s%s",Christ_, Christ_cypherSalt);
    
        WORD key_schedule[60], idx;
        BYTE enc_buf[128], enc_buf4[128];
        BYTE plaintext4[16];// ={0x6b,0xc1,0xbe,0xe2,0x2e,0x40,0x9f,0x96,0xe9,0x3d,0x7e,0x11,0x73,0x93,0x17,0x2a};
        //char * Gospel_command = "scroll";
        ...
        //split the received radio string to get pin+salt and cipher text
        
        //if(strlen(Christ_cypherSalt)>7 && strlen(Christ_)>7)uBit.display.scroll(GODly);
        //uBit.serial.printf(Christ_cypherSalt);
        //uBit.serial.printf("\n%s",Christ_);
        uBit.serial.printf("\n%d",mercy);
        if(mercy>=3){
        uBit.serial.printf("\n%s",GODly);
        uBit.serial.printf("\n%d",strlen(GODly));
        strncpy(Christ_pinSalt, GODly, 3);
        Christ_pinSalt[3] = '\0';
        
        strcpy(JesusChrist_cypher, &GODly[3]);
        ...
        int Jesus;
        BYTE Christ[100];
        //sprintf(key, "%02x", (unsigned int) buf[0]);
      ...
      //AES ECB DECRYPTION
        ...
        //print_hex(key, 32);
           ...
           // print_hex(plaintext4, strlen((char*)plaintext4));
             //uBit.serial.printf("\n-cipher: ");
            //print_hex(JesusChrist_cypher, strlen((char*)JesusChrist_cypher));
       ...
       //char *plaintext6="1J5";
       //Hash the pin+salt to obtain dp key
             //uBit.display.scroll(Christ_pinSalt);
             //uBit.display.scroll(JesusChrist_cypher);
             //uBit.display.scroll(Gospel_command5);
