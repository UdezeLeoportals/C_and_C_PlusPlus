     ...
     while(1){
       ...
       sprintf(Christ_salt, "%s", "J");
        ...
        if (uBit.buttonA.isPressed()){
            ...
            sprintf(Christ_salt, "%d%s", pin, Christ_salt); //pin+salt concatenation
            ...
            sha256_init(&ctx);
            sha256_update(&ctx, (BYTE*)Christ_salt, strlen((char*)Christ_salt));
            ...
            print_hex(plaintext4, strlen((char*)plaintext4));
             uBit.serial.printf("\n-encrypted to: ");
            print_hex(enc_buf, strlen((char*)enc_buf));
